            ...
            <ul>
              @foreach ($categories as $category)
                <li class="mb-4" wire:key="{{ $category->id }}">
                  <label for="" id="{{ $category->slug }}" class="flex items-center dark:text-gray-400 ">
                    <input type="checkbox" value="{{ $category->id }}" id="{{ $category->slug }}" class="w-4 h-4 mr-2">
            ...
            <ul>
              @foreach ($brands as $brand)
                <li class="mb-4" wire:key="{{ $brand->id }}">
                  <label for="" id="{{ $category->slug }}" class="flex items-center dark:text-gray-300">
              ...
              <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                <div class="border border-gray-300 dark:border-gray-700">
                  ...
                  <div class="p-3 ">
                    ...
                    <p class="text-lg ">
                      <span class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'Tsh') }}</span>
                    </p>
                  </div>
